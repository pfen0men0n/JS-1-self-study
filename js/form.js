...
/**
 * @function onFormSubmit функция отправки формы
 * @param {*} evt в качестве параметра принимает событие
 * @if содержит условие, если валидация пристин не проходит, то отменяется дейстивие по умолчанию и форма не отправится
 */
...
function addPristineValidation () {
    imgFormElement.addEventListener('onchange', onFormSubmit);
